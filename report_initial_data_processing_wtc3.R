...
#' 	
#' #### Here we focus on *Case 2*: processing the WTC-3 data from the start of drought treatment (12 Feb 2014) to the end of the experiment (26 May 2014)       	
#' 	
#' <!-- #---------------------------------------------------------------------------------------------------------------- -->	
#' <!-- #---------------------------------------------------------------------------------------------------------------- -->	
#'    	
