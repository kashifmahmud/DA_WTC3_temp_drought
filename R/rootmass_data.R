...
height.dia.initial = subset(height.dia.final, Date %in% as.Date("2014-02-18"))
...
# height.dia.initial <- summaryBy(RM+RM_SE ~ T_treatment+chamber_type, data=height.dia.initial, FUN=c(mean))
# names(height.dia.initial)[3:4] <- c("RM","RM_SE")
# height.dia.initial$Date = as.Date("2014-02-12")
