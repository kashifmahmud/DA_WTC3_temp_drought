...
# height.dia = subset(height.dia, Date >= as.Date("2014-02-12") & Date <= as.Date("2014-05-27"))
...
for(i in 1:length(chambers)) {
  ...
  # height.dia.sub = subset(height.dia.sub, DateTime >= as.Date("2014-02-12") & Date <= as.Date("2014-05-27"))
