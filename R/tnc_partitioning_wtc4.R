...
# There was no statistically significant difference in TNC partitioning accross the treatments as John tested.
...
tnc.partitioning = subset(tnc.partitioning, Date >= as.Date("2014-02-18") & Date <= as.Date("2014-05-26"))
