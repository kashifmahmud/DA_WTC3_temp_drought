...
pd <- position_dodge(3)
p2 = ggplot(data.biomass[complete.cases(data.biomass$litter),], aes(x=Date, y=litter, group = interaction(T_treatment,chamber_type), colour=T_treatment, shape=chamber_type)) + 
